...
import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR
} from "./chunk-NSWQ6G55.js";
import "./chunk-LROYRZJW.js";
import {
  DOCUMENT,
  Directive,
  ElementRef,
...
var NgxMaskDirective = class _NgxMaskDirective {
  ...
  errors = input([], ...ngDevMode ? [{
    debugName: "errors"
  }] : []);
  disabled = input(false, ...ngDevMode ? [{
    debugName: "disabled"
  }] : []);
  touched = model(false, ...ngDevMode ? [{
    debugName: "touched"
  }] : []);
  dirty = input(false, ...ngDevMode ? [{
    debugName: "dirty"
  }] : []);
  invalid = input(false, ...ngDevMode ? [{
    debugName: "invalid"
  }] : []);
  pending = input(false, ...ngDevMode ? [{
    debugName: "pending"
  }] : []);
  ...
  _isSignalFormsMode = signal(false, ...ngDevMode ? [{
    debugName: "_isSignalFormsMode"
  }] : []);
